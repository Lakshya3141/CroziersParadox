...
filter <- list(
  ...
  dMutationStrengthCues = c(0.5, 1, 5),
  dFracKilled = c(0.4),
  dMetabolicCost = c(40),
  dExpParam = c(0.1),
...
##### Diversity Cues Plot ####
x_col <- "dMutationStrengthCues"        # Specify the column for the x-axis
x_tit <- expression("Mutation Strength (cues)")
