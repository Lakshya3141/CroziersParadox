...
#### Create param grid ####
param_grid <- expand.grid(dFK = dFracKilled, dTT = dTickTime, dEP = dExpParam, iKC = iKillChoice, iMC = iModelChoice, rp = replicates)
...
for (i in 1:nrow(param_grid)) {
  ...
  create_config(dFracKilled = focal_dFK, dExpParam = focal_dEP, dTickTime = focal_dTT, iKillChoice = focal_iKC, iModelChoice = focal_iMC,
                params_to_record = "iModelChoice,dFracKilled,dExpParam,dTickTime,iKillChoice")
