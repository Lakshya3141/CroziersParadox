...
double dTickTime = 4.0;                           // Time after which population stock is reset IF iConstPopStock = 2
double dOutputTime = 50.1;                        // Interval after which population stats are outputed
double dFracDeadNest = 0.8;                       // Fraction of dead nests recorded in output files
