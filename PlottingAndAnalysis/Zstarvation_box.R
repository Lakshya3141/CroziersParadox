...
##### Diversity Cues Plot ####
x_col <- "dTickTime"        # Specify the column for the x-axis
x_tit <- expression("Global resources renewal time (" * italic(t)[gen] * ")")
y_col <- "bcnest_avg"          # Specify the column for the y-axis
y_tit <- "Cue Diversity"
group_col_x <- "dFracKilled"  # Specify the column for grouping in the x direction
group_col_y <- "dMutationStrength" # Specify the column for grouping in the y direction
...
plots <- generate_boxplots_combined_no_spacing(filtered_data, x_col, y_col, 
                                               x_tit = x_tit, y_tit = y_tit, 
                                               group_col_x = group_col_x, group_col_y = group_col_y, 
                                               group_color = group_color, box_width = 0.5, 
                                               com_scale = TRUE, color_palette = color_pallete,
                                               aspect_ratio = 1, x_angle = x_angle, dodge_width = 0.3, 
                                               jitter_width = 0.2, outlier_size = 0.8)
  
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/div.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
ggsave(paste0("./additional/",name_file,"/counts.png"), plot = plots$cplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
print(plots$boxplot)
print(plots$cplot)
...
plots <- generate_boxplots_combined_no_spacing(filtered_data, x_col, y_col, 
                                               ...
                                               com_scale = TRUE, color_palette = color_pallete,
                                               aspect_ratio = 1, x_angle = x_angle, dodge_width = 0.3, 
                                               jitter_width = 0.3, outlier_size = 0.8)

# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/div_drift.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
...
plots <- generate_boxplots_combined_no_spacing(filtered_data, x_col, y_col, 
                                               ...
                                               group_col_x = group_col_x, group_col_y = group_col_y, 
                                               group_color = group_color, box_width = 0.5, 
                                               com_scale = TRUE, color_palette = "Set1",
                                               aspect_ratio = 1, x_angle = x_angle, dodge_width = 0.3, 
                                               jitter_width = 0.3, outlier_size = 0.8)

# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/intercept.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)

##### Slope Plot ####
y_col <- "slope_avg"          # Specify the column for the y-axis
y_tit <- expression("Linear Slope (" * italic(T)[res] * ")")
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/slope.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/abun.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)

##### Abundance Drift Plot ####
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/abun_drift.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)

##### SucSteal Plot ####
y_col <- "sucstealfrac"          # Specify the column for the y-axis
y_tit <- "Frac. Suc. Raids"
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/stealfrac.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)

##### SucRentry Plot ####
y_col <- "sucrentry"          # Specify the column for the y-axis
y_tit <- "Frac. Suc. Re-entry"
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/rentryfrac.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
...
# Save the boxplot with fixed dimensions
ggsave(paste0("./additional/",name_file,"/lineages.png"), plot = plots$boxplot, width = plots$width, height = plots$height, units = "in", dpi = 300)
