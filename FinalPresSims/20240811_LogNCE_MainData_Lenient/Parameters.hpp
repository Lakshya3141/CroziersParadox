...
const double dInitIntercept = 1.1;                // Initial value of intercept for linear / logistic comparison
const double dInitSlope = -2.2;                    // Initial value of slope for linear / logistic function
