...
const double dInitIntercept = 3.6;                // Initial value of intercept for linear / logistic comparison
const double dInitSlope = -7.1;                    // Initial value of slope for linear / logistic function
