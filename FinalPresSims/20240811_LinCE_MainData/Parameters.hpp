...
const double dInitIntercept = 0.5;                // Initial value of intercept for linear / logistic comparison
const double dInitSlope = 0.0;                    // Initial value of slope for linear / logistic function
bool bIsCoevolve = true;                         // Wether tolerance co-evolves with the cues
