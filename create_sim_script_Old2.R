...
#### Create param grid ####
param_grid <- expand.grid(dMSC = dMutationStrengthCues, dMC = dMetabolicCost, dFK = dFracKilled, iKC = iKillChoice, rp = replicates)
...
focal_iKC <- param_grid$iKC[sim_number]
create_config(dMutationStrengthCues = focal_dMSC, dFracKilled = focal_dFK, dMetabolicCost = focal_dMC, iKillChoice = focal_iKC,
